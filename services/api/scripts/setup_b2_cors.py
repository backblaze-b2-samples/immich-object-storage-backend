...
RULE_ID = "immich-b2-direct-upload"
...
def _client():
    ...
    # CORS calls sign more reliably with an explicit region_name. Both the
    # region and the derived endpoint come from B2_REGION — no region literal
    # lives in this file.
    ...
    return boto3.client(
        ...
        config=Config(signature_version="s3v4", user_agent_extra="b2ai-immich-object-storage-backend"),
    )
