...
API_TITLE = "Immich B2 Backend API"
API_DESCRIPTION = (
    "Local API for the Immich B2 Backend sample, a self-hosted photo library "
    "whose originals, thumbnails, CLIP embeddings, smart tags, and EXIF "
    "sidecars all live on Backblaze B2. This contract documents the sample's "
